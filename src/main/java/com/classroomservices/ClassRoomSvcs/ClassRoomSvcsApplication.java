...
import com.classroomservices.ClassRoomSvcs.dao.CustomerRepository;
...
public class ClassRoomSvcsApplication {
	...
	private static final Logger log = LoggerFactory.getLogger(ClassRoomSvcsApplication.class);
